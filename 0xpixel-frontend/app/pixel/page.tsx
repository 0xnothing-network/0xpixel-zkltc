...
// Heavy components loaded only on the client after the initial paint.
// This keeps the initial JS chunk for /pixel tiny — GSAP + wagmi + viem +
// canvas drawing logic all ship as separate chunks that load when the user
...
export default function PixelPage() {
  ...
  return (
    <div style={{ fontFamily: "var(--font-departure)" }}>
      {/* Hero — pure CSS animation, no GSAP. SSR friendly. */}
